    ...
    <div class="panel panel-default">
    	...
    	<div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group col-md-12">
                        <label><strong>Gejala yang nampak pada motor matic :</strong></label>
                    </div>
                </div>
                <div class="col-md-12">
                    <ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <p><strong>Motor matic anda kemungkinan besar terkena masalah: {{ $diagnosa->penyakit->nama }}.</strong></p>
                        <div class="row">
                            <div class="col-md-2">
